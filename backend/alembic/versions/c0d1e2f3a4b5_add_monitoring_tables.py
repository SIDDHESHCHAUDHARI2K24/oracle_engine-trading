...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "universe_id", sa.UUID(), sa.ForeignKey("universes.id"), nullable=False
        ),
        ...
        sa.Column(
            "is_alert", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
        sa.Column(
            "computed_at",
        ...
        sa.UniqueConstraint(
            "universe_id", "horizon", "measurement_date", "window_size"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "universe_id", sa.UUID(), sa.ForeignKey("universes.id"), nullable=True
        ),
